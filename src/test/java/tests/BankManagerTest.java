...
public class BankManagerTest {
    ...
    public void methodTest() {
        ...
        //bankManagerTT.customers.get(0).firstName = propertyUtility.getAllData().get("firstNameValue");
        //bankManagerTT.customers.get(0).lastName = propertyUtility.getAllData().get("lastNameValue");
        //bankManagerTT.customers.get(0).postCode = propertyUtility.getAllData().get("postCodeValue");
